...
space. Do not use a value greater than 31.
...
/*                            calc_S					 */
/*===========================================================*/
U_int calc_S(U_int xJ, U_int val)
{
	U_int retval, temp1, temp2;
